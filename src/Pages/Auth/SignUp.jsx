...
//   setLoading(false);
//   if (err.response) {
//     console.log("Server error response:", err.response.data); // ADD THIS
//     toast.error(`Error: ${err.response.data.message || "Something went wrong!"}`);
//   } else if (err.inner) {
//     const formattedErrors = err.inner.reduce((acc, curr) => {
//       acc[curr.path] = curr.message;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (activeTab === "artisan") {
        ...
        await axios.post("https://artisan-dic2.onrender.com/user/register-user", payload);
...
//             <h2 className="text-xl font-bold mb-4 text-[#003636]">Registration Successful!</h2>
//             <p className="mb-6 text-gray-600">
//               Please complete your artisan profile to start receiving job requests.
//             </p>
//             <button
//               onClick={() => {
//                 setShowModal(false);
...
//               }}
//               className="bg-[#003636] text-white py-2 px-6 rounded hover:bg-[#002b2b]"
//             >
//               Complete Bio Data
//             </button>
//           </div>
